...
public class ReportingHostedService : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        {
            var parentContext = RabbitMqDiagnostics.Propagator.Extract(default, ea.BasicProperties,
            ...
            lock (_batchLock)
            {
                ...
                _activityLinks.Add(new ActivityLink(parentContext.ActivityContext));
    ...
    private static void ProcessBatch(ConcurrentBag<string> messageBatch, ConcurrentBag<ActivityLink> links)
    {
